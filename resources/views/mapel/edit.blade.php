@extends('layout.main',['title' => 'Edit Mata Pelajaran '] )
    ...
    <div class="col">
        <form class="form-horizontal" action="{{url ('mapelUpdate/'.$model->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kode_mapel" name="kode_mapel" value="{{$model->kode_mapel}}" placeholder="kode mapel">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="mapel">Mapel:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="mapel" name="mapel" value="{{$model->mapel}}" placeholder="Masukkan Mapel">
                </div>
            </div>
