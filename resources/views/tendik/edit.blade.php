@extends('layout.main',['title' => 'Edit Tendik '] )
    ...
    <div class="col">
        <form class="form-horizontal" action="{{url ('tendikUpdate/'.$model->id_tendik) }}" method="POST">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="nama_tendik">Nama:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nama_tendik" name="nama_tendik" value="{{$model->nama_tendik}}" placeholder="Masukkan Nama">
                </div>
            </div>
            <div class="form-group">
